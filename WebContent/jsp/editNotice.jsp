...
<meta charset="UTF-8">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="notice/addNotice" method="post">
                    <div class="layui-form-item">
                        <label for="L_email" class="layui-form-label">
                            <span class="x-red">*</span>标题</label>
                        <div class="layui-input-inline">
                            <input type="text" id="title" name="totallimit" required="" lay-verify="totallimit" autocomplete="off" class="layui-input"></div>
...
//                 });
                ...
                function(data) {
                	var flag;
                    console.log(data);
                    $.post("notice/addNotice", {title:$("#title").val(),content:$("#content").val(),status:$("#status").val()}, function(data) {
                    	flag = data;
                    });
                    layer.alert("增加成功", {
                           icon: 6
